    ...
    return (
      <div className={classes.box} id='about'>
        ...
        <div className={classes.About}>
          <p>
            Hi! My name is <b>ADITYA RAJ SHRIVASTAVA</b>. I am a passionate developer having experience in{' '}
            <b>Frontend</b> & <b>React App </b> development complemented by backend expertise and
            ...
            as a <b>Web Developer Engineer.</b> I am much interested in developing new things
